...
SECRET_KEY = 'django-insecure-h2zhc1zd8ni%64l!=k+9!kk+3^x3@*8t0f#=mf55pj2#t2tcve'
...
# when @login_required kicks in
LOGIN_URL = '/login/'   # <- this is the path from your accounts app
